...
**复核中登记的"与文档不符"六条**——owner 2026-09-16 裁：**只登记、不开 issue**；本件**不改 `code/tools/**`**
...
| 6 | [#169 证据](../engineering/evidence/panic-posture-2026-09-16.md) 的**未闭合 #1 已就地划改**为"2026-09-16 **三轮目视后定稿** · owner 已确认通过并结账"（[切片](../slices/CP-01-ward-1f/slice.md) 脚注同），但**同一份证据的"未做的事"行与页脚**、以及[证据索引](../engineering/evidence/README.md)该行的"未闭合"列**仍写着"owner 目视未做"** ⇒ 只读索引的一份复核把它判成"目视未做"（本次复核即发生一次，已按证据 §八.1 纠正） | 候选队列：回填那三处（**超出 #173 预期差分**，本件只登记）；在那之前 **#169 的目视状态以证据 §八.1 为准** |
