...
**维度定义、分拣标准与实时完成度以 [设计框架-六维状态](framework/six-dimensions.md) 为唯一来源**（本文不复述，避免三处不同步）。

按维度的文档索引见 [维度索引目录](framework/dimensions/)。
...
第5优先级（收尾）
  ...
  5.3 校验脚本实现 — ✅ 已有 9 个 validate_*.py，全绿       [管线]
  5.4 Unity项目搭建                                        [管线]
  5.5 测试策略                                              [管线]
  5.6 搁置角色处理                                          [实体]
```

## 本轮设计共识（2026-07-26 ~ 28 的四轮讨论结论，共 69 项决策——历史记录）
...
- **三因子调制**：兴奋性（Momi 2025）× 传导速度（Hansen 2024 时间层级）× 神经调质增益（**系数为本仓估计**，社区划分依 Hansen 2024）
...
### 实体
- [疾病特长](entities/%E7%96%BE%E7%97%85%E7%89%B9%E9%95%BF.md) — **开局**：成因两条腿 = 经历（给基本属性 + 解锁疾病候选）+ 玩家自己的选择；48 段经历 × 8 玩家主题，限额 10 段 + 互斥；属性 0–10，并为五项 × 五档提供能力描述；26 病总表（开门/关门/代价）（2026-09-18 owner 体验反馈修正）
- [角色与面具](entities/%E8%A7%92%E8%89%B2%E4%B8%8E%E9%9D%A2%E5%85%B7.md) — 14 角色/面具/共享症状（14 角色 = 26 病卡的机制来源）
...
- [X Bot 动画处理能力对照实验](presentation/%E5%8A%A8%E7%94%BB%E5%A4%84%E7%90%86%E8%83%BD%E5%8A%9B%E5%AF%B9%E7%85%A7%E5%AE%9E%E9%AA%8C.md) — **两条线**（Unity/Blender）共用的共同样本与观测口径（2026-09-14 立并接受 #156/#157/#158；同日 owner 裁定 Unreal 线不建、收窄为两条线——见该文 §七 第 6 行与 [Unreal 探针证据](engineering/evidence/unreal-animation-probe-2026-09-14.md)）
