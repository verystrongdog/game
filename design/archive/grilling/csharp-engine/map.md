...
- 审计 10 项关键修复全部吸收进 [plan.md](../../../spec/engine/csharp-engine-roadmap.md)：解析解数值、ParticipantState HP/SAN、双通道声明结构、IsDefending、δ 实时注入、3 行动 NPC 候选集、CD 窗口起点 tick、W 数据绑定、命名空间分层、gate→结算接线
...
- [plan.md v1.0 → v1.1](../../../spec/engine/csharp-engine-roadmap.md) → 审计修订版实施计划 → 获批
