...
- GitHub 镜像：code/tools/sync_issues.py（幂等同步，本地为真相源）

## Decisions-so-far

- [任务issue 01](design/issues/01-data-layer-spec.md) → 4 决策（D1-D4），GitHub #42
- [spec v1.2](../../../spec/engine/csharp-data-layer.md) → 13 enum + 18 record + 5 loader 方法 + 14 AC，GitHub 审计报告见 [report.md](design/audit/report.md)
