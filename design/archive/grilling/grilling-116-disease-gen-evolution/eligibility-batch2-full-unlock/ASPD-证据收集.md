...
> 纪律约束（沿用 #113/#116）：G1-G4 全局不变量、反样本纪律、表征偏好 ≠ 资格阈值、症状计数不得充当资格原子、MISSING ≠ FALSE、禁止"创伤事件→原子"（转化接口 §3.2.2 :213）、患者层"目标实例化合法化"不得回灌资格层（[决策记录-平凡实例化](../%E5%86%B3%E7%AD%96%E8%AE%B0%E5%BD%95-%E5%B9%B3%E5%87%A1%E5%AE%9E%E4%BE%8B%E5%8C%96.md) D4 两层隔离铁律）。

| 项 | 值 |
|----|-----|
| Type | 资格核验批次 2（证据收集，子代理产出，待用户裁决） |
| 归属 | [#116](https://github.com/verystrongdog/game/issues/116) 配额表驱动核验批次（平凡实例化裁定 D6）+ [批次 2 总览](%E6%80%BB%E8%A7%88.md) G5 ASPD 行 |
| 前置 | #113 资格层（Eligibility(d)/原子三值/G1-G4）+ [批次 1 BPD 定案（BPD_PATTERN_HISTORY）](../eligibility-batch1-sexual-trauma/BPD-%E6%A0%B8%E9%AA%8C%E6%94%B6%E5%B0%BE.md) + 批次 1 模板 |
| 目标病 | 反社会型人格障碍（ASPD） |
| 项目通道 | **A 临床史主导**（[批次 2 总览](%E6%80%BB%E8%A7%88.md) G5 行工作地图初判；通道归属是核验产物而非输入——批次 1 BPD 曾由"C 混合"修正为"A 主导"，本文件不预设结论） |
...
| ASPD 疾病目录 | 父类人格障碍，疾病ID `aspd`，创伤易感事件类型 `[忽视/遗弃]`（镜像）；核心病理"自我社会域↓ 解耦沉默（共情缺失）+ 防御域↓（威胁反应低）+ 认知控制域↓（冲动控制失败）"；14 条病理边 aspd_e01-e14 全为**解耦沉默**（m 负偏移），CU traits→右侧杏仁核活动↓ 右偏 +0.2 | [design/entities/diseases/反社会型人格障碍.md](../../../../entities/diseases/%E5%8F%8D%E7%A4%BE%E4%BC%9A%E5%9E%8B%E4%BA%BA%E6%A0%BC%E9%9A%9C%E7%A2%8D.md) :6/:13/:19 |
| 父类（人格障碍） | 默认病理类型"解耦沉默 或 过度耦合"；子类含 ASPD/BPD/分裂型 | [design/entities/diseases/_parent-classes/人格障碍.md](../../../../entities/diseases/_parent-classes/%E4%BA%BA%E6%A0%BC%E9%9A%9C%E7%A2%8D.md) |
...
| D5 | SSD 先例：时长/年龄窗类条件做成**声明侧原子**合法（SYMPTOM_DURATION_6M——"≥6 月判定留 #87 声明侧"，CYCLIC 配方）——"onset before age 15"同为年龄窗判定，可同构 | [SSD-收尾-裁决点.md](SSD-%E6%94%B6%E5%B0%BE-%E8%A3%81%E5%86%B3%E7%82%B9.md) :27/:35 | 支持：若做原子，15 岁边界判定留声明侧 |
...
| 病理边 | aspd_e01-e14 全部为**解耦沉默**（m 负偏移）——冷酷共情缺失（vmPFC/ACC/mPFC 信号发不出）、防御域低威胁反应（杏仁核→PAG）、TPJ 换位思考失败、dlPFC 冲动控制失败 | [design/entities/diseases/反社会型人格障碍.md](../../../../entities/diseases/%E5%8F%8D%E7%A4%BE%E4%BC%9A%E5%9E%8B%E4%BA%BA%E6%A0%BC%E9%9A%9C%E7%A2%8D.md) :19-36；Dugré et al. 2020/Dugré & Potvin 2021（文献锚） |
| BPD 收尾纪律 | BPD 核验修正结论：E_d^mem 仅作**起草侧参考，不进资格门**（无记忆签名/OGM 方向；高 F 与 PTSD 混淆反样本） | [BPD-核验收尾.md](../eligibility-batch1-sexual-trauma/BPD-%E6%A0%B8%E9%AA%8C%E6%94%B6%E5%B0%BE.md) #1 |
...
| E9 | 结构性纪律：批次纪律 = 表征偏好 ≠ 资格阈值；BPD 收尾 = E_d^mem 仅作起草侧参考不进资格门；ASPD 无记忆形态锚 → A 通道（临床史主导）为工作地图初判（[批次 2 总览](%E6%80%BB%E8%A7%88.md) G5 行）；"纯表征能否资格化"若为"是"需回应上述全部反样本——本文件只收材料 | 批次 1 总览 §三.4；BPD 收尾 #1；批次 2 总览 | 不表态 |
...
| V14 | ICD-11 conduct-dissocial disorder → **已核验（镜像）**：6C91 系（6C91.0 儿童起病型等，+ limited prosocial emotions 限定 [需核验逐字]）；残留：官方英文逐字 | 原文核对（残留项） | WHO ICD-11 MMS / 镜像（§1.5） |
...
- 本批次并行产出：见 [批次 2 总览](%E6%80%BB%E8%A7%88.md)（G1-G6 各证据收集子代理运行中）；DSM-5 细节配套档：[ASPD-DSM细节核验-证据补充.md](ASPD-DSM%E7%BB%86%E8%8A%82%E6%A0%B8%E9%AA%8C-%E8%AF%81%E6%8D%AE%E8%A1%A5%E5%85%85.md)（应答 V1/V6 + AMPD/CD 逐字锚 + 7 项独立缺口清单）。

---

*创建: 2026-09-06 | 状态: 证据收集完成（待用户裁决）*
*关联: [批次 2 总览](%E6%80%BB%E8%A7%88.md), [批次 1 BPD 证据收集](../eligibility-batch1-sexual-trauma/BPD-%E6%A0%B8%E9%AA%8C-%E8%AF%81%E6%8D%AE%E6%94%B6%E9%9B%86.md), [批次 1 BPD 收尾](../eligibility-batch1-sexual-trauma/BPD-%E6%A0%B8%E9%AA%8C%E6%94%B6%E5%B0%BE.md), [转化接口 §3.2.2](../../../../rules/skill-tree/%E5%88%9B%E4%BC%A4%E8%AE%B0%E5%BF%86%E8%BD%AC%E5%8C%96%E6%8E%A5%E5%8F%A3.md), [反社会型人格障碍疾病目录](../../../../entities/diseases/%E5%8F%8D%E7%A4%BE%E4%BC%9A%E5%9E%8B%E4%BA%BA%E6%A0%BC%E9%9A%9C%E7%A2%8D.md), [决策记录-平凡实例化](../%E5%86%B3%E7%AD%96%E8%AE%B0%E5%BD%95-%E5%B9%B3%E5%87%A1%E5%AE%9E%E4%BE%8B%E5%8C%96.md), [ASPD-DSM细节核验-证据补充.md](ASPD-DSM%E7%BB%86%E8%8A%82%E6%A0%B8%E9%AA%8C-%E8%AF%81%E6%8D%AE%E8%A1%A5%E5%85%85.md)*
