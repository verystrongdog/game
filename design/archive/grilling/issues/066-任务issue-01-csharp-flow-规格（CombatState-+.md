# #66 任务issue 01: csharp-flow 规格（CombatState + TurnManager + ActionResolver）

> 状态：开放 · 创建 2026-08-14
> 标签：维度:管线, needs-triage
> 原始：https://github.com/verystrongdog/game/issues/66
...
本地: .scratch/csharp-flow/design/issues/01-flow-spec.md
