...
| [P4c-2026-09-12.md](P4c-2026-09-12.md) | P4c 数据契约 | 100 文件 manifest · runtime allowlist 双向 · 53 条跨语言 fixture **判定逐条相同零豁免** · 11/11 校验器 · 415 tests · 抓出 6 个真实缺陷 | hansen2024 五个文件零消费者（需 owner 裁定）· 三项外部数据许可未登记 · Unity 阻塞 P4d 消费闭合 |
