...
*关联: [grilling-88.md](grilling-88.md), [ptsd-pilot.md](ptsd-pilot.md), [反社会型人格障碍](aspd-pilot.md), [NPC AI 行为模型](../../规则/技能树系统/NPC AI 行为模型.md) §4/§5.2, [偏侧化架构](../../规则/技能树系统/偏侧化架构.md) §四/§八, [脑功能层级模型](../../规则/技能树系统/脑功能层级模型.md), [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七, [角色与面具](../../实体/角色与面具.md) §8.8, [tripartite_model.json](../../data/connectivity/tripartite_model.json)*
