...
*关联: [grilling-88.md](grilling-88.md), [ptsd-pilot.md](ptsd-pilot.md), [广泛性焦虑障碍](../../实体/疾病目录/广泛性焦虑障碍.md), [特定恐惧症](../../实体/疾病目录/特定恐惧症.md), [NPC AI 行为模型](../../规则/技能树系统/NPC%20AI%20行为模型.md) §3.5/§4.2/§5.2, [脑功能层级模型](../../规则/技能树系统/脑功能层级模型.md) §二十, [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §四/§七（焦虑障碍）, [tripartite_model.json](../../data/connectivity/tripartite_model.json)*
*待办: 疾病目录新建 [惊恐障碍](../../实体/疾病目录/惊恐障碍.md)（父类 焦虑唤醒障碍，Q0.5）+ term_registry 入库（Q0.4 命名标准——DSM-5 命名 + disease_id=`panic-disorder`）*
