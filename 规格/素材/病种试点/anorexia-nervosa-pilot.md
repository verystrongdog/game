...
*关联: [grilling-88.md](grilling-88.md), [PTSD 重映射试点](ptsd-pilot.md), [神经性厌食症](../../实体/疾病目录/神经性厌食症.md), [神经性贪食症](../../实体/疾病目录/神经性贪食症.md)（相反模式对照）, [NPC AI 行为模型](../../规则/技能树系统/NPC AI 行为模型.md) §4.2/§5.2, [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七, [tripartite_model.json](../../data/connectivity/tripartite_model.json), [link_registry.json](../../data/connectivity/link_registry.json)（⚠️ 已废弃）*
