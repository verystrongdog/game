...
| # | 文献 | 类型 | 关键数据点（→ 病理边用途） |
|---|------|------|--------------------------|
| 1 | **ENIGMA SZ — Van Erp et al. (2016)** *Biol Psychiatry*（[疾病-脑区链路映射-文献数据源.md](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §3.2/§七 精神分裂症） | 结构 mega-meta | 海马 d=−0.4、杏仁核 d=−0.3、丘脑 d=−0.3、NAcc↓、苍白球↑、侧脑室 d=+0.3 → 记忆/防御/奖赏/行动门控域边的**结构锚 + 方向**（e07/e08/e10/e12/e20/e21） |
...
| 4 | **Fan & Tan (2022)** DMN-FPN 反相关消失（[文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七 精神分裂症 整合域） | 静息态 trait marker | DMN-FPN **反相关消失** = 精分 trait marker → e05（mOFC↔dlPFC 解耦沉默，旧「边界崩溃」语义继承）+ §五 整合域跳变（L5 叙事重构不可用） |
...
*关联: [ptsd-pilot.md](ptsd-pilot.md), [grilling-88.md](grilling-88.md), [偏执型精神分裂症](../../实体/疾病目录/偏执型精神分裂症.md), [NPC AI 行为模型](../../规则/技能树系统/NPC AI 行为模型.md) §4/§5.2, [偏侧化架构](../../规则/技能树系统/偏侧化架构.md) §四, [脑功能层级模型](../../规则/技能树系统/脑功能层级模型.md) §二十, [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七, [ENIGMA偏侧化-精神疾病大样本meta-文献数据源](../../参考/文献/ENIGMA偏侧化-精神疾病大样本meta-文献数据源.md) §三/§四/§五/§九, [tripartite_model.json](../../data/connectivity/tripartite_model.json)*
