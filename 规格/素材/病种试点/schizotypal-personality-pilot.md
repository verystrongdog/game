...
- **世界观层接壤**（[世界观与叙事](../../事件/世界观与叙事.md) 拜月教/思维造物主题）：NPC AI §5.3 边界——链路决定"容易产生认知扭曲"，具体信念内容（思维造物/神谕解读）在叙事层，本文件只落机制。
...
> 新增病无旧「行为覆盖」表——本节为分裂型机制（**认知扭曲/古怪信念**）的新设计挂接，格式照 PTSD §五。世界观层接壤：以下机制只决定"容易产生认知扭曲"，具体信念内容（思维造物/神谕解读）由[世界观与叙事](../../事件/世界观与叙事.md) 拜月教/思维造物主题提供（NPC AI §5.3 边界）。
...
*关联: [grilling-88.md](grilling-88.md), [ptsd-pilot.md](ptsd-pilot.md), [反社会型人格障碍](aspd-pilot.md), [边缘型人格障碍](borderline-personality-pilot.md), [NPC AI 行为模型](../../规则/技能树系统/NPC AI 行为模型.md) §4/§5.2/§5.3, [偏侧化架构](../../规则/技能树系统/偏侧化架构.md) §四/§八, [脑功能层级模型](../../规则/技能树系统/脑功能层级模型.md), [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §五/§七, [世界观与叙事](../../事件/世界观与叙事.md), [角色与面具](../../实体/角色与面具.md) §8.8, [tripartite_model.json](../../data/connectivity/tripartite_model.json)*
