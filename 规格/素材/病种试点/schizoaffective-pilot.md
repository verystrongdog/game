...
| # | 文献 | 类型 | 关键数据点（→ 病理边用途） |
|---|------|------|--------------------------|
| 1 | **Madre et al. (2016)** *Acta Psychiatr Scand*（[疾病-脑区链路映射-文献数据源.md](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七 分裂情感性） | 结构系统综述 | **灰质体积丧失介于精分与双相之间，更接近精分** → m 偏移以精分模式为主（×0.8），BD 成分为叠加（×0.5） |
...
| 4 | **Fountoulakis et al. (2019)** PANSS 五因子（§五）+ BD 模式（[文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七 双相） | PANSS / 汇总 | 五因子全可卷入（混合心境 = 抑郁/焦虑因子 + 兴奋/敌意因子交替主导）；BD 奖赏域双向、唤醒域振荡 → §五 心境相位翻转挂接 + 唤醒域边（e07） |
...
*关联: [ptsd-pilot.md](ptsd-pilot.md), [grilling-88.md](grilling-88.md), [分裂情感性障碍](../../实体/疾病目录/分裂情感性障碍.md), [偏执型精神分裂症](../../实体/疾病目录/偏执型精神分裂症.md), [双相障碍I型](../../实体/疾病目录/双相障碍I型.md), [NPC AI 行为模型](../../规则/技能树系统/NPC AI 行为模型.md) §4/§5.2, [偏侧化架构](../../规则/技能树系统/偏侧化架构.md) §四, [脑功能层级模型](../../规则/技能树系统/脑功能层级模型.md) §二十, [疾病-脑区链路映射-文献数据源](../../参考/文献/疾病-脑区链路映射-文献数据源.md) §七, [ENIGMA偏侧化-精神疾病大样本meta-文献数据源](../../参考/文献/ENIGMA偏侧化-精神疾病大样本meta-文献数据源.md) §三/§四/§五/§九, [tripartite_model.json](../../data/connectivity/tripartite_model.json)*
