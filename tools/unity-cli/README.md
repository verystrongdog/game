...
> 在 WSL 侧驱动 Windows 上的 Unity Editor（`com.unity.pipeline`）做编译 / 生成 / 测试 / 截图验证的封装脚本。首次使用见 [Grilling #126 决策记录](../../.scratch/grilling-126-rosefield/决策记录.md) §本机实测。
...
*关联: [Grilling #126 决策记录](../../.scratch/grilling-126-rosefield/决策记录.md), [unity/README.md](../../unity/README.md)*
