...
*关联: [Grilling #70 路线图 task-plan](./../grilling-70-engine-roadmap/task-plan.md), [Grilling #72 P1a task-plan](./../grilling-72-p1a-skill-context/task-plan.md), [核心机制](./../../规则/核心机制.md), [皮层动力学-通用层](./../../规则/技能树系统/皮层动力学-通用层.md), [运行时状态模型](./../../规则/技能树系统/运行时状态模型.md), [csharp-engine plan](./../csharp-engine/design/plan.md), [数学语言书写规范](./../../docs/agents/math-language-writing.md)*
