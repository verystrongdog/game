...
| v1.1 | 2026-08-13 | 审计修复（1❌+6⚠️+6ℹ️，详见 audit/report.md）：迭代语义统一固定 300 回合（AC-4/9/10 + §六声明）；CiRows 公开访问器（AC-1 可测）；ramp 内联 §4.5；§4.3 配对措辞防 ordinal 陷阱；AC-12 包含性断言声明；B4 构造偏差入表；C1 KeyNotFound 文档化；AC-9 SD2 ≈0 注 / AC-10 端点与非单调注；AC-5/6 链参数补全 | 全量审计退回（E1 必须修复） | Δ审计（变更章节 + 半径扩张） |
