...
*关联: [Grilling #70 路线图 task-plan](./../grilling-70-engine-roadmap/task-plan.md), [Grilling #72 P1a task-plan](./../grilling-72-p1a-skill-context/task-plan.md), [Grilling #73 P1b task-plan](./../grilling-73-p1b-linkstate/task-plan.md), [运行时状态模型](./../../规则/技能树系统/运行时状态模型.md), [技能生成机制](./../../规则/技能树系统/技能生成机制.md), [NPC AI 行为模型](./../../规则/技能树系统/NPC%20AI%20行为模型.md), [数学语言书写规范](./../../docs/agents/math-language-writing.md)*
